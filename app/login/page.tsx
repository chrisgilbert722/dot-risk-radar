      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <Card className="w-full max-w-md border-slate-800 bg-slate-900">
          ...
          <CardContent className="text-center text-sm text-slate-500">
            Click the link in the email to sign in to your account. The link will expire in 60 minutes.
          </CardContent>
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="border-slate-800 bg-slate-900">
          <CardHeader>
            <CardTitle className="text-2xl text-white">Sign in to DOT Risk Radar</CardTitle>
            <CardDescription className="text-slate-400">
